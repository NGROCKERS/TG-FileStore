            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton("DJ REMIX CHANNEL", url="https://t.me/ADARSHMEDIAS")
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=ADARSHMEDIASr_{str_to_b64(file_er_id)}"
                ...
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton("WEBSITE",
                                             ...
                                             url="https://ngrockers.blogspot.com")
